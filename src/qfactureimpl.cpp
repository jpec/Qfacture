...
void QfactureImpl::on_cSave_clicked()
{
  ...
  if (cId->text().isEmpty())
    ...
    query.prepare(
		  "UPDATE client "
		  "SET Name = :name, Adress = :adress, Adress2 = :adress2, Zip = :zip, "
		  "    City = :city, Phone = :phone, Mail = :mail "
		  "WHERE Id = :id "
		  );
...
{
  /** Ajoute l'article dans la facture **/
